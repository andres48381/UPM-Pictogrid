...
int main(int argc,char* argv[])
{
	...
	glutCreateWindow("PICTOGRID CLIENTE");
...
void OnTimer(int value)
{
	...
	if(escenario.pass>escenario.GetPantalla())//COMPARA EL NV.PANTALLA DEL SERV CON EL DEL CLIENT
		{
		if(escenario.GetPantalla()<=10)
			{
